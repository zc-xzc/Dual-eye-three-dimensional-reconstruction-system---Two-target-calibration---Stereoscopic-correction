# -*- coding=utf-8 -*-
#位置在480行左右parser.add_argument('--source_img_path', type=str, default='D:/data00/0327/img')
import time
import random
import copy
import cv2
...
class DataAugmentForObjectDetection():
    ...
    def _addNoise(self, img):
        ...
        '''
        rng = np.random.default_rng(int(time.time()))  # 使用新的 rng 参数
        return random_noise(img, mode='gaussian', rng=rng, clip=True) * 255
...
class ToolHelper():
    ...
    def save_img(self, file_name, save_folder, img):
        img = np.clip(img, 0, 255).astype(np.uint8)  # 确保图像为 uint8 格式
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_img_path', type=str, default='D:\Desktop\yolo\数据集/test/0327/img')
    parser.add_argument('--source_xml_path', type=str, default='D:\Desktop\yolo\数据集/test/0327/xml')
    parser.add_argument('--save_img_path', type=str, default='D:\Desktop\yolo\数据集/test/0327/img2')
    parser.add_argument('--save_xml_path', type=str, default='D:\Desktop\yolo\数据集/test/0327/xml2')
