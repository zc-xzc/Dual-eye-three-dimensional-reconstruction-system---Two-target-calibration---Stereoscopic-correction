...
def parse_opt():
    ...
    parser.add_argument('--img_root', type=str, default='D:\Desktop\PycharmProjects\数据增强/0327\img2')
    parser.add_argument('--lable_root', type=str, default='D:\Desktop\PycharmProjects\数据增强/0327/txt2')
